...
\begin{center}
    \begin{tabular}{c|lcc|l}
        ...
        \hline & & & & \\
        tNE & north & & S & south\\
        stNE & near north & & nS & near south \\
        ftNE & far north & & fS & far south \\
        & & & & \\
        tNW & northwest & & SW & southwest \\
        stNW & near northwest & &  nSW & near southwest \\
        ftNW & far northwest & &  fSW & far southwest \\
        & & & & \\
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tikzpicture}
            ...
            \node[tank, scale = 1.5, /agitator=flat] (Bempty) at (-2, -2) {};
